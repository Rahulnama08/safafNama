...
function CarouselContent({ className, ...props }) {
  ...
  return (
    <div ref={carouselRef} className="overflow-hidden" data-slot="carousel-content">
      <div className={cn("flex transition-transform duration-300 ease-in-out", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className)} {...props} />
    </div>
  );
}
...
function CarouselItem({ className, ...props }) {
  ...
  return (
    <div
      ...
      aria-roledescription="slide"
      data-slot="carousel-item"
      className={cn("min-w-0 shrink-0 grow-0 basis-full rounded-lg overflow-hidden shadow-sm", orientation === "horizontal" ? "pl-4" : "pt-4", className)}
      {...props}
    />
  );
}
...
function CarouselPrevious({ className, variant = "outline", size = "icon", ...props }) {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute size-8 rounded-full shadow hover:shadow-md transition-shadow duration-200",
