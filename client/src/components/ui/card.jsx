...
function Card({ className, ...props }) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-3xl border border-gray-200/70 py-6 shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out",
        className
      )}
      {...props}
    />
